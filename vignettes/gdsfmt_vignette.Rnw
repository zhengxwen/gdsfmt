...
\section{Installation of the gdsfmt package}

To install the package \Biocpkg{gdsfmt}, you need a current version (>=2.14.0)
...
add.gdsn(gfile, "bit2", val=sample(0:3, 1000, replace=TRUE))
