...
type.list <- c("int8", "int16", "int24", "int32", "int64",
	...
	"float32", "float64", "packedreal8", "packedreal16", "packedreal32",
	"string", "string16", "string32", "fstring", "fstring16", "fstring32")

# a list of compression algorithms
compress.list <- c(
	"ZIP", "ZIP.none", "ZIP.fast", "ZIP.default", "ZIP.max",
	"ZIP_RA", "ZIP_RA.none", "ZIP_RA.fast", "ZIP_RA.default", "ZIP_RA.max",
